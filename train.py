...
# Work Done by Harsh Gorakhnath Guddetwar Sakshi Gupta
...
class Train:
    def __init__(self, root):
        ...
        img_bottom=Image.open(r"D:\final project\ATTENDANC3E USING FACE RECOGNITION\college pics\train.02.jpg")
